  ...
  <div class="flex gap-3">
    <div class="flex h-6 shrink-0 items-center">
      <div class="group grid size-4 grid-cols-1">
        <input id="comments" aria-describedby="comments-description" name="comments" type="checkbox" v-model="isChecked"
    ...
    <div class="text-sm/6 text-gray-600">
      <label for="comments">
        <span class="font-bold mr-1">Remind me</span>
        <span>with a text message</span>
      </label>
    </div>
  </div>
</template>
