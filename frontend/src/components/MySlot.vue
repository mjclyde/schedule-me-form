<template>
  <div
    class="outline outline-1 outline-gray-200 text-lg text-gray-700 font-semibold py-4 px-5 my-4 rounded-md shadow-sm flex items-center"
    ...
    <button @click="$emit('delete')" v-if="!isPast" type="button"
