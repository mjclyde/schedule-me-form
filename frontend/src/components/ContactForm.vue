<template>
  <div class="isolate -space-y-px rounded-md shadow-sm">
    <div v-if="!phoneOnly"
      class="relative rounded-md rounded-b-none px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-sky-500">
    ...
    <div
      class="relative rounded-md px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-sky-500"
      :class="[phoneOnly ? 'rounded-t-md' : 'rounded-t-none']">
      ...
      <div class="relative py-1">
        ...
        <input v-maska="'(###) ###-####'" v-model="phone" type="tel" name="phone" id="phone"
          class="pl-10 block w-full border-0 p-0 text-gray-900 placeholder:text-gray-300 focus:ring-0 sm:leading-6"
